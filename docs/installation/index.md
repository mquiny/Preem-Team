---
title: Installing the CPE Collection
description: Step-by-step installation guide for the Preem Team CPE collection.
---
...
!!! danger "We do not support Pirated copies"
    We do not support, endorse or recommend you mod Cyberpunk with a pirated copy of the game, Please make sure you have a legitimate copy of the game aquired through Steam/GOG/Epic Games, we will not offer support to those who are running non-legit copies of the game.
...
<details class="pt-step" markdown="1" data-pt-step="1" id="step-1-verify-game-version">
<summary>
<span class="pt-step-label">
<input type="checkbox" class="pt-step-check" data-pt-step-check aria-label="Mark Step 1 complete">
<span class="pt-step-title">Step 1: Verify game version</span>
</span>
</summary>
...
<details class="pt-step" markdown="1" data-pt-step="2" id="step-2-prepare-vortex">
<summary>
<span class="pt-step-label">
<input type="checkbox" class="pt-step-check" data-pt-step-check aria-label="Mark Step 2 complete">
<span class="pt-step-title">Step 2: Installing and Preparing Vortex</span>
</span>
</summary>
...
1. **Grab the latest version of Vortex.**
      ...
      - Make sure you are also on the latest Cyberpunk2077 Vortex extension [Here](https://www.nexusmods.com/site/mods/196?tab=files) - Make sure to select "Manual Download" and simply drag the .zip file into the extensions tab in Vortex
        ...
        ??? example "📷 Show me"
            ![Dragging the extension into Vortex](assets/update-extension.png){ width="500" }
...
2. **Manage Game in Vortex.**
      - Next you want to go to the 'Home' tab in vortex, select 'Games' and search for Cyberpunk, then select 'Manage', to allow vortex to edit your game install.
        ...
        ??? example "📷 Show me"
            ![Manage Game](assets/manage-game-first.png){ width="500" }
...
3. **Configure Vortex Settings.**
      ...
      **V2077 Settings**
      ...
      - Inside of V2077 Settings you want to make sure 'Don't prompt when reaching the fallback installer' is ticked (enabled).
        ...
        ??? example "📷 Show me"
            ![Make sure fallback is enabled](assets/skip-fallback-prompt-first.png){ width="500" }
      ...
      **Staging Folder**
      ...
      - For the "Mod Staging Folder" click on the little folder to the left of "Suggest" to choose where you want the staging folder to be
        ...
        ??? example "📷 Show me"
            ![Set Staging Folder](assets/staging.png){ width="500" }
...
<span class="pt-step-title">Step 3: Vortex - Select collection</span>
</span>
</summary>
...
=== "Through Nexus Mods"
    ...
    ??? example "📷 Show me"
        ![Latest revision selected](assets/select-latest-revision.png){ width="500" }

</details>

<details class="pt-step" markdown="1" data-pt-step="4" id="step-4-vortex-collection-install">
<summary>
<span class="pt-step-label">
<input type="checkbox" class="pt-step-check" data-pt-step-check aria-label="Mark Step 4 complete">
<span class="pt-step-title">Step 4: Vortex - Install Collection</span>
</span>
</summary>
...
1. **Confirm Installation.**
    ...
    ??? example "📷 Show me"
        ![Select Profile Install](assets/select-new-profile.png){ width="500" }
    ??? example "📷 Show me"
        ![Confirm Profile Install](assets/confirm-new-profile.png){ width="500" }	
!!! tip
...
<details class="pt-step" markdown="1" data-pt-step="5" id="step-5-verify-installation">
<summary>
<span class="pt-step-label">
<input type="checkbox" class="pt-step-check" data-pt-step-check aria-label="Mark Step 5 complete">
<span class="pt-step-title">Step 5: Verify installation</span>
</span>
</summary>
