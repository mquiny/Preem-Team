---
title: Adding Personal Mods to Preem Edition
description: Guide for safely adding your own personal mods alongside the Preem Edition collection.
---
...
<p class="pt-judy-quote">"Cool ain't free. Neither's a build that doesn't break the second you touch it." <cite>— Rogue Amendiares</cite></p>
...
!!! warning "Mods we don't recommend using with PE"
...
<details class="pt-step" markdown="1" data-pt-step="1" id="step-1-create-cloned-profile">
<summary>
<span class="pt-step-label">
<input type="checkbox" class="pt-step-check" data-pt-step-check aria-label="Mark Step 1 complete">
<span class="pt-step-title">Step 1: Create a cloned profile</span>
</span>
</summary>
...
??? example "📷 Show me"
    ![Cloning a profile in Vortex](assets/clone_profile.png){ width="500" }
...
<details class="pt-step" markdown="1" data-pt-step="2" id="step-2-check-mod-page">
<summary>
<span class="pt-step-label">
<input type="checkbox" class="pt-step-check" data-pt-step-check aria-label="Mark Step 2 complete">
<span class="pt-step-title">Step 2: Check the mod page</span>
</span>
</summary>
...
??? example "📷 Show me"
    ![Ultra Plus's Nexus requirements section](assets/ultra_plus_reqs.png){ width="500" }
...
<details class="pt-step" markdown="1" data-pt-step="3" id="step-3-check-game-runs">
<summary>
<span class="pt-step-label">
<input type="checkbox" class="pt-step-check" data-pt-step-check aria-label="Mark Step 3 complete">
<span class="pt-step-title">Step 3: Check the game runs</span>
</span>
</summary>
...
<details class="pt-step" markdown="1" data-pt-step="4" id="step-4-repeat-for-more-mods">
<summary>
<span class="pt-step-label">
<input type="checkbox" class="pt-step-check" data-pt-step-check aria-label="Mark Step 4 complete">
<span class="pt-step-title">Step 4: Repeat for every mod you want to add</span>
</span>
</summary>
...
<details class="pt-step" markdown="1" data-pt-step="5" id="step-5-enjoy">
<summary>
<span class="pt-step-label">
<input type="checkbox" class="pt-step-check" data-pt-step-check aria-label="Mark Step 5 complete">
<span class="pt-step-title">Step 5: Enjoy your new experience</span>
</span>
</summary>
