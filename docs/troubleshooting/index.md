...
description: Support hub for the Preem Team collection.
---
...
1. Check [Common Problems](common_problems.md) — your issue is probably already documented.
2. Check the [Changelog](../changelog/index.md) for a "Breaking change" notice if you just updated.
...
!!! tip "Writing a good bug report"
    ...
    - [ ] Whether you installed via Vortex or manually
    - [ ] Exact steps to reproduce the issue
    - [ ] Your CET console log (attach as a file, don't paste a screenshot)
